...
def parse_args():
    ...
    parser.add_argument('--preset', type=str, nargs='+', choices=p.PreSet.all_preset_names(), default=[], help='If set, use a predefined configuration (default: all presets)')
    parser.add_argument('--verbose', action='store_true', help='If set, print verbose output (default: False)')

    args = parser.parse_args()

    presets = p.PreSet.preset_from_names(args.preset)
